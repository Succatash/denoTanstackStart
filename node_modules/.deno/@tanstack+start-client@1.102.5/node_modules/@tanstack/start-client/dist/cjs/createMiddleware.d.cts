...
import { Assign, Constrain, Expand, IntersectAssign, ResolveValidatorInput, ResolveValidatorOutput, SerializerStringify } from '@tanstack/react-router';
...
export type AssignAllClientContextAfterServer<TMiddlewares, TClientContext = undefined, TClientSendContext = undefined, TClientAfterContext = undefined> = unknown extends TClientContext ? Assign<Assign<TClientContext, TClientSendContext>, TClientAfterContext> : Assign<AssignAllMiddleware<TMiddlewares, 'allClientContextAfterServer'>, Assign<Assign<TClientContext, TClientSendContext>, TClientAfterContext>>;
/**
...
export type MiddlewareClientAfterNextFn<TMiddlewares, TClientContext, TClientSendContext> = <TNewClientAfterContext = undefined>(ctx?: {
    context?: TNewClientAfterContext;
    sendContext?: never;
    headers?: HeadersInit;
}) => Promise<ClientAfterResultWithContext<TMiddlewares, TClientContext, TClientSendContext, TNewClientAfterContext>>;
export interface MiddlewareClientAfterFnOptions<in out TMiddlewares, in out TValidator, in out TClientContext, in out TClientSendContext> {
    data: Expand<IntersectAllValidatorInputs<TMiddlewares, TValidator>>;
    context: Expand<AssignAllClientContextAfterServer<TMiddlewares, TClientContext, TClientSendContext>>;
    method: Method;
    next: MiddlewareClientAfterNextFn<TMiddlewares, TClientContext, TClientSendContext>;
}
export type MiddlewareClientAfterFn<TMiddlewares, TValidator, TClientContext, TClientSendContext, TNewClientAfterContext> = (options: MiddlewareClientAfterFnOptions<TMiddlewares, TValidator, TClientContext, TClientSendContext>) => MiddlewareClientAfterFnResult<TMiddlewares, TClientContext, TClientSendContext, TNewClientAfterContext>;
export type MiddlewareClientAfterFnResult<TMiddlewares, TClientContext, TClientSendContext, TNewClientAfterContext> = Promise<ClientAfterResultWithContext<TMiddlewares, TClientContext, TClientSendContext, TNewClientAfterContext>> | ClientAfterResultWithContext<TMiddlewares, TClientContext, TClientSendContext, TNewClientAfterContext>;
...
export type ClientAfterResultWithContext<in out TMiddlewares, in out TClientContext, in out TClientSendContext, in out TClientAfterContext> = {
    'use functions must return the result of next()': true;
    context: Expand<AssignAllClientContextAfterServer<TMiddlewares, TClientContext, TClientSendContext, TClientAfterContext>>;
    headers: HeadersInit;
};
...
export interface MiddlewareTypes<TMiddlewares, TValidator, TServerContext, TServerSendContext, TClientContext, TClientSendContext, TClientAfterContext> {
    _types: {
        ...
        allClientContextAfterServer: AssignAllClientContextAfterServer<TMiddlewares, TClientContext, TClientSendContext, TClientAfterContext>;
        validator: TValidator;
    };
    options: MiddlewareOptions<TMiddlewares, TValidator, TServerContext, TClientContext>;
}
export interface MiddlewareAfterValidator<TMiddlewares, TValidator> extends MiddlewareTypes<TMiddlewares, TValidator, undefined, undefined, undefined, undefined, undefined>, MiddlewareServer<TMiddlewares, TValidator, undefined, undefined>, MiddlewareClient<TMiddlewares, TValidator> {
}
...
export interface MiddlewareAfterClientAfter<TMiddlewares, TValidator, TServerContext, TServerSendContext, TClientContext, TClientSendContext, TClientAfterContext> extends MiddlewareTypes<TMiddlewares, TValidator, TServerContext, TServerSendContext, TClientContext, TClientSendContext, TClientAfterContext> {
}
export interface MiddlewareClientAfter<TMiddlewares, TValidator, TServerContext, TServerSendContext, TClientContext, TClientSendContext> {
    clientAfter: <TNewClientAfterContext = undefined>(clientAfter: MiddlewareClientAfterFn<TMiddlewares, TValidator, TClientContext, TClientSendContext, TNewClientAfterContext>) => MiddlewareAfterClientAfter<TMiddlewares, TValidator, TServerContext, TServerSendContext, TClientContext, TClientSendContext, TNewClientAfterContext>;
}
export interface MiddlewareAfterServer<TMiddlewares, TValidator, TServerContext, TServerSendContext, TClientContext, TClientSendContext> extends MiddlewareTypes<TMiddlewares, TValidator, TServerContext, TServerSendContext, TClientContext, TClientSendContext, undefined>, MiddlewareClientAfter<TMiddlewares, TValidator, TServerContext, TServerSendContext, TClientContext, TClientSendContext> {
}
...
export interface MiddlewareAfterClient<TMiddlewares, TValidator, TServerSendContext, TClientContext> extends MiddlewareTypes<TMiddlewares, TValidator, undefined, TServerSendContext, TClientContext, undefined, undefined>, MiddlewareServer<TMiddlewares, TValidator, TServerSendContext, TClientContext> {
}
...
export interface MiddlewareAfterMiddleware<TMiddlewares> extends MiddlewareTypes<TMiddlewares, undefined, undefined, undefined, undefined, undefined, undefined>, MiddlewareServer<TMiddlewares, undefined, undefined, undefined>, MiddlewareClient<TMiddlewares, undefined>, MiddlewareValidator<TMiddlewares> {
}
